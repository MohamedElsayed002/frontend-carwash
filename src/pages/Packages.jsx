...
import { Star, Clock, Search, Car, AlertCircle, Crown, CheckCircle, Loader2, BarChart, Zap, Award } from 'lucide-react';
...
const Packages = () => {
  ...
  const handlePackageClick = async (packageData) => {
    ...
    const response = await fetch(`https://carwash-backend-production.up.railway.app/api/users/add-package`, {
      ...
      body: JSON.stringify({ packageData: packageInfo })
    })
                        ...
                        <div className="relative">
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              fetchPackagesBySize(e.target.value);
                            }}
