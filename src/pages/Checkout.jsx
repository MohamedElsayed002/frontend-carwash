...
import { orderAPI, paymentAPI, qrAPI, hyperpayAPI } from '../api';
...
const Checkout = () => {
  ...
  const loadCheckoutData = async () => {
    try {
      ...
      // Try to create reservation data from package details if not available
      let reservation;
      if (storedReservation) {
        ...
        // Save the created reservation data
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8">
              ...
              {selectedPaymentMethod === 'apple-pay' && (
                <ApplePayPayment
                  ...
                  onError={handlePaymentError}
                  onCancel={() => {
                    setSelectedPaymentMethod('hyperpay');
                  }}
                />
              )}
