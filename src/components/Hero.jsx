              ...
              <div className="app-card relative bg-white rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl p-0 transform transition-all duration-500 hover:shadow-2xl sm:hover:shadow-3xl hover:scale-105 overflow-hidden">
                ...
                <div className="relative bg-gradient-to-br from-green-500 via-green-600 to-green-700 p-4 sm:p-6 md:p-8 text-center">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex justify-center items-center mb-3 sm:mb-4">
                      <div className="w-20 h-20 rounded-full bg-white/90 backdrop-blur-sm  sm:rounded-2xl flex items-center justify-center border border-white/50 shadow-lg">
                        <img src={logo} alt="PayPass Logo" className="w-16 h-16 sm:w-10 sm:h-10 md:w-12 md:h-12 object-contain" />
                      </div>
                    </div>
                ...
                <div className="p-4 sm:p-6 md:p-8 bg-white">
                  <div className="space-y-3 sm:space-y-4 md:space-y-6">
                    {/* الميزة الأولى */}
                    <div className="flex items-center gap-2 sm:gap-4 flex-row  px-10 md:px-0">
